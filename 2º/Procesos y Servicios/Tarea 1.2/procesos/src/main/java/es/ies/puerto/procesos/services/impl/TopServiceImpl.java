...
/**
 * Servicio para ejecutar el comando top -b -n1
 */
@Service
public class TopServiceImpl implements CommandService {
    
    private static final String COMMAND = "top -b -n1";
    ...
    public String getName() {
        return "top -b -n1 (System processes snapshot)";
    }
}
