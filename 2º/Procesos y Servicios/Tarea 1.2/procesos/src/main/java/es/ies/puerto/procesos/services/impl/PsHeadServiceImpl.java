...
/**
 * Servicio para ejecutar el comando ps aux | head
 */
@Service
public class PsHeadServiceImpl implements CommandService {
    
    private static final String COMMAND = "ps aux | head";
    ...
    public String getName() {
        return "ps aux | head (List first processes)";
    }
}
